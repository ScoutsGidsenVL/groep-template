...
loadmore === null || loadmore === void 0 ? void 0 : loadmore.addEventListener('click', function (e) {
  var elementList = _toConsumableArray(document.querySelectorAll('.news-feed .col'));
...
var selectContactNumber = document.querySelector('#selectContactNumber');
selectContactNumber.addEventListener('change', function (event) {
  var selectedContactNumber = document.querySelector('.contactNumber');
